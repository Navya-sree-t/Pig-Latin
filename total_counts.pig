...
//rough
all_data = load 'D:/Big_DataHadoop_Projects-master/basketball_match_analysis/gamedata/*EV{A,N}' using PigStorage(',') as (teams:chararray);
al_data =  load 'D:/Big_DataHadoop_Projects-master/basketball_match_analysis/gamedata/*EVA' using PigStorage(',') as (team:chararray); 
nl_data =  load 'D:/Big_DataHadoop_Projects-master/basketball_match_analysis/gamedata/*EVN' using PigStorage(',') as (team:chararray);